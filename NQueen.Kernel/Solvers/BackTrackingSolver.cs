...
// Todo: Refactor this class with regard to readability, maintainability, SRP, memory usage,
// and performance.

// Todo: Cancelling the simulation causes the following error message in a Modal Dialogbox:
// An error occured during simulation: No solution were generated by the solver.
// I think me also need to add a test method to make sure this won't happen in the future.

// Todo: Find out if is possible to estimate the amount of completed job in the SingleMode case
// and if so change the indefinite progressbar to a standard one.
