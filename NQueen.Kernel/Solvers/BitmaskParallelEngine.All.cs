...
/// <summary>
/// Parallel engine partial: logic for full materialization of all solutions.
/// </summary>
internal sealed partial class BitmaskParallelEngine
{
    public void RunAll(AllRequest request)
    {
        ...
        // Build root frames to split search space
        ...
        foreach (var root in rootList)
        {
            tasks.Add(Task.Run(() =>
            {
                ...
                int col = startCol;
                ulong remaining = ComputeAvailable();
                ...
                ulong ComputeAvailable() => ~(cols | d1 | d2) & mask;
